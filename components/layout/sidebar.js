...
export default function SideBar() {
  ...
  return (
    <>
      <div className="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-72">
          ...
          <nav className="mt-6">
            <div>
              ...
              <Link href="/compose/devit">
                <a
                  className={`${
                    matchPath(PATH_NAMES.COMPOSE_DEVIT)
                      ? 'navbar-item-active'
                      : 'navbar-item'
                  }`}
                  href="#"
